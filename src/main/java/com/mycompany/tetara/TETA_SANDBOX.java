...
public class TETA_SANDBOX extends javax.swing.JFrame {
    ...
    private void appendToPPETerminal(String text) {
        SwingUtilities.invokeLater(() -> { // Update Swing component on EDT
            ...
            txtPPETerminal.append(text + "\n");
            
            // Auto-scroll to the bottom
            txtPPETerminal.setCaretPosition(txtPPETerminal.getDocument().getLength()); 
        
        
        });
    }
    
    private void updateTotalTransactionData(long tx){
        totalTxData += tx;
        double res = totalTxData/(1024.0*1024.0);
        SwingUtilities.invokeLater(() -> { // Update Swing component on EDT
            txtTotalTx.setText(String.format("%.3f",res));
        });
    }
    ...
    private static void initializeEpoch(TETA_SANDBOX sandboxInstance, int epochNumber, int epochCycle, int numSlots, List<Validator> validators,String speed ) {
        ...
        for (int slot = 0; slot < numSlots && sandboxInstance.running; slot++) {
            ...
            if (slot == 0) {
                ...
                blockchain.shardAndStoreBlock(newBlock, totalTxData -> {
                    // Update the relevant text field in your GUI using totalTxData
                    sandboxInstance.updateTotalTransactionData(totalTxData);
                });
                //blockchain.printBlockchain("latestBlock");
                 blockchain.printBlockchain("latestBlock", (block, output) -> { 
                    sandboxInstance.appendToTerminal(output.toString());
         ...
         blockchain.reconstructAndPrintBlockchain(output -> {
             sandboxInstance.appendToPPETerminal(output);
         });
        }).start();
        ...
        blockchain.reconstructAndPrintBlockchain(output -> sandboxInstance.appendToPPETerminal(output)); // Call the new method
    ...
    public TETA_SANDBOX() {
        ...
        btnInterupt.setContentAreaFilled(false);
        btnInterupt.setOpaque(false); 
        Color customColor = Color.decode("#B34E8C");
        btnInterupt.setBorder(new javax.swing.border.LineBorder(Color.WHITE, 1));
        
        btnInvoke.setContentAreaFilled(false);
        btnInvoke.setOpaque(false); 
        
        btnInvoke.setBorder(new javax.swing.border.LineBorder(Color.WHITE, 1));
        setIconImage(new ImageIcon(getClass().getResource("/images/TETARA-BLU (1).png")).getImage()); 
    ...
    private void initComponents() {
        ...
        txtTotalTx = new javax.swing.JTextField();
        ...
        jLabel9.setFont(new java.awt.Font("Nasalization Rg", 0, 11)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Total Slots");

        jLabel10.setFont(new java.awt.Font("Nasalization Rg", 0, 12)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("Epoch Cycle");

        jLabel11.setFont(new java.awt.Font("Nasalization Rg", 0, 11)); // NOI18N
        ...
        jLabel5.setFont(new java.awt.Font("Nasalization Rg", 1, 12)); // NOI18N
        ...
        jLabel12.setFont(new java.awt.Font("Nasalization Rg", 0, 11)); // NOI18N
        ...
        jLabel21.setFont(new java.awt.Font("Nasalization Rg", 2, 14)); // NOI18N
        ...
        jLabel19.setFont(new java.awt.Font("Nasalization Rg", 2, 14)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(255, 255, 255));
        jLabel19.setText("Shard & DAS Terminal");

        jLabel15.setFont(new java.awt.Font("Nasalization Rg", 2, 14)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(255, 255, 255));
        jLabel15.setText("Validation Terminal");

        jLabel3.setFont(new java.awt.Font("Montserrat", 2, 10)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Block Creation & Distribution");

        jLabel4.setFont(new java.awt.Font("Montserrat", 2, 10)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Sharded Block Reconstruction");
        ...
        jLabel16.setFont(new java.awt.Font("Nasalization Rg", 0, 10)); // NOI18N
        ...
        btnInterupt.setFont(new java.awt.Font("Nasalization Rg", 0, 12)); // NOI18N
        ...
        jLabel20.setFont(new java.awt.Font("Nasalization Rg", 0, 10)); // NOI18N
        ...
        jLabel22.setFont(new java.awt.Font("Nasalization Rg", 0, 10)); // NOI18N
        ...
        jLabel23.setFont(new java.awt.Font("Nasalization Rg", 0, 10)); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtCurrentBlock, javax.swing.GroupLayout.PREFERRED_SIZE, 225, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtCurrentLeader, javax.swing.GroupLayout.PREFERRED_SIZE, 225, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(15, 15, 15)))
                .addComponent(btnInterupt, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(btnInterupt, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addContainerGap())
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(6, 6, 6)
        ...
        txtTotalTx.setBackground(new java.awt.Color(51, 51, 51));
        txtTotalTx.setFont(new java.awt.Font("Nasalization Rg", 0, 25)); // NOI18N
        txtTotalTx.setForeground(new java.awt.Color(255, 255, 255));
        txtTotalTx.setText("TX");
        txtTotalTx.setBorder(null);

        jLabel25.setFont(new java.awt.Font("Nasalization Rg", 1, 36)); // NOI18N
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtTotalTx, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, Short.MAX_VALUE)
        ...
        jLabel2.setText("Hybrid Modular Blockchain - a Network for Public & Private Transactions ");
    ...
    private void btnInvokeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInvokeActionPerformed
        ...
        totalTxData = 0;
        running = true; // Signal the thread to stop
    ...
    private javax.swing.JTextField txtTotalTx;
